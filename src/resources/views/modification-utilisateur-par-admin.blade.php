...
@section('title', 'Administration - Modification des informations utilisateur')
@section('css')
        ...
        <div class="row layout-spacing">
                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center">
                            <img src="{!! asset('images/'.$user->photo) !!}" alt="avatar" style="width: 150px; height: 150px;">
                            <div class="user-info">
                                <p class="">{{$user->name}}</p>
                            </div>
                        </div>
                            ...
                            <div class="">
                                <ul class="contacts-block list-unstyled">
                                    ...
                                    <li class="contacts-block__item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>{{\Carbon\Carbon::parse($user->birth_date)->format('d/m/Y')}}
                                    </li>
                                    <li class="contacts-block__item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg> {{$user->username}}
                                    </li>
                                    <li class="contacts-block__item">
            ...
            <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                ...
                <div class="skills layout-spacing ">
                    <div class="widget-content widget-content-area">
                        <h3 class="">Modification d'informations</h3>
                        <div class="row">
                            <form id="form-user-password" method="post" action="{!! route('modifier_utilisateur_par_admin',$user->id) !!}" enctype="multipart/form-data" class="general-info">
                                @csrf
                                <div class="info">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control tagging profiles   @error('profiles') is-invalid @enderror" multiple="multiple" name="profiles[]" id="profiles">
                                                    @foreach($listeProfile as $profile)
                                                        <option value="{{ $profile->id }}" @if(in_array($profile->id,$userProfiles)) {!! 'selected' !!} @endif>{{$profile->profile_name}}</option>
                                                    @endforeach
                                                </select>
                                                @error('profiles')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    @can('EDIT_USER')
                                         ...
                                         <input type="submit" id="valider_modification" class="btn btn-primary submit-fn" value="Valider"/>
                                    @endcan
                                </div>
                            </form>
                        </div>
